      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-3 gap-3 py-6">
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--kronos-primary)]/50 hover:bg-card">
            ...
            <LockIcon className="mb-2 h-5 w-5 text-[var(--kronos-primary)]" />
          ...
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--kronos-primary)]/50 hover:bg-card">
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--kronos-primary)]/0 to-[var(--kronos-primary)]/5 opacity-0 transition-opacity group-hover:opacity-100" />
            <Zap className="mb-2 h-5 w-5 text-[var(--kronos-primary)]" />
          ...
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--kronos-primary)]/50 hover:bg-card">
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--kronos-primary)]/0 to-[var(--kronos-primary)]/5 opacity-0 transition-opacity group-hover:opacity-100" />
            <DollarSign className="mb-2 h-5 w-5 text-[var(--kronos-primary)]" />
        ...
        <div className="flex flex-col items-center gap-3">
          <Button
            ...
            className="h-10 bg-[var(--kronos-primary)] text-white shadow-[var(--kronos-primary)]/25 shadow-lg hover:bg-[var(--kronos-primary)]/90"
          >
          ...
          <p className="text-center text-muted-foreground text-xs">
            ...
            >
              <code className="rounded bg-muted px-1.5 py-0.5 text-[var(--kronos-primary)]">
