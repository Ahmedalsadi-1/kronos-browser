    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--accent-kronos)]">
            <img src="/icon/mainkronos-logo.png" alt="kronosOS-assistant" className="h-6 w-6" />
          </div>
          <span className="font-semibold text-[var(--accent-kronos)] text-lg">
            kronosOS-assistant
          </span>
        </div>
