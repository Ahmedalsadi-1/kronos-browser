            ...
            {steps.map((step) => {
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    className="absolute top-3.5 left-[50%] h-1 bg-[var(--kronos-primary)]"
                    initial={false}
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-2">
                    <div className="relative">
                      ...
                      {isActive && (
                        <div className="absolute inset-0 animate-ping rounded-full bg-[var(--kronos-primary)] opacity-30" />
                      )}
                      <div
                        className={`relative flex h-8 w-8 items-center justify-center rounded-full font-semibold text-sm transition-all duration-500 ${
                          isCompleted
                            ? 'bg-[var(--kronos-primary)] text-white'
                            : isActive
                              ? 'bg-[var(--kronos-primary)] text-white ring-4 ring-[var(--kronos-primary)]/20'
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="flex items-center justify-between pt-8">
            ...
            {canGoNext ? (
              <Button
                asChild
                className="group bg-[var(--kronos-primary)] text-white hover:bg-[var(--kronos-primary)]/90"
              >
