...
const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      'Let KRONOS Agent browse, click, type, and complete tasks for you. Just describe what you need done!',
    highlights: [
      {
  ...
  },
  {
    ...
    tag: 'PRODUCTIVITY',
    Icon: Layers,
    title: 'KRONOS as MCP Server',
    description:
      'Connect KRONOS with Claude Code, Claude Desktop, and other MCP clients for powerful agentic browser automation',
    highlights: [
      {
    ...
    videoDuration: '1:40',
    tip: 'Use commands like "Open amazon.com on kronos" to control your browser directly from Claude! Read the setup guide to get started.',
    gridClass: 'md:col-span-1',
      ...
      <section className="relative border-border/40 border-b">
          ...
          <div className="space-y-8 text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  Why Switch to{' '}
                  <span className="text-[var(--accent-kronos)]">
                    KRONOS?
                  </span>
                </h1>
                <p
                ...
                >
                  Watch our launch video to understand the vision of KRONOS
                  and key features!
                </p>
              </div>
            </div>
            ...
            >
              <video
                ...
                title="KRONOS MCP Server Demonstration"
                autoPlay
                muted
                loop
                playsInline
        ...
        >
          <div className="text-center">
            ...
            <ArrowDown className="mx-auto h-6 w-6 text-[var(--accent-kronos)]" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        <div className="mb-12 space-y-3 text-center">
          ...
          <h2 className="font-bold text-3xl tracking-tight md:text-4xl">
            Explore What&apos;s{' '}
            <span className="text-[var(--accent-kronos)]">Possible</span>
          </h2>
      ...
      <section className="mx-auto max-w-7xl border-border/40 border-y px-6 py-16">
        <div className="mx-auto max-w-5xl">
          <div className="mb-8 flex items-center gap-3">
            <LinkIcon className="h-6 w-6 text-[var(--accent-kronos)]" />
            <h2 className="font-bold text-3xl">
              Join our community and help us improve{' '}
              <span className="text-[var(--accent-kronos)]">KRONOS!</span>
            </h2>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a
              ...
              className="community-card group flex items-start gap-4 rounded-xl border border-border bg-card p-6 transition-all hover:-translate-y-1 hover:border-[var(--accent-kronos)]/50 hover:bg-card/80 hover:shadow-[var(--accent-kronos)]/5 hover:shadow-lg"
            >
              ...
              <div className="space-y-1">
                <h3 className="font-semibold text-lg transition-colors group-hover:text-[var(--accent-kronos)]">
                  Join Discord
                </h3>
                <p className="text-muted-foreground text-sm">
            ...
            <a
              ...
              className="community-card group flex items-start gap-4 rounded-xl border border-border bg-card p-6 transition-all hover:-translate-y-1 hover:border-[var(--accent-kronos)]/50 hover:bg-card/80 hover:shadow-[var(--accent-kronos)]/5 hover:shadow-lg"
            >
              <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-[var(--accent-kronos)]/10 transition-all group-hover:scale-110 group-hover:bg-[var(--accent-kronos)]/20">
                <BookOpenText className="h-6 w-6 text-[var(--accent-kronos)]" />
              </div>
              <div className="space-y-1">
                <h3 className="font-semibold text-lg transition-colors group-hover:text-[var(--accent-kronos)]">
                  Documentation
      ...
      <section className="mx-auto max-w-7xl px-6 pt-16 pb-56">
        <div className="space-y-4 text-center">
          <Button
            onClick={handleStart}
            size="lg"
            className="bg-[var(--accent-kronos)] text-white shadow-[var(--accent-kronos)]/25 shadow-lg hover:bg-[var(--accent-kronos)]/90"
          >
            Start Using KRONOS
