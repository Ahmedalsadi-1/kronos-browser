    ...
    <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
      <div className="flex items-start gap-4">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--accent-kronos)]/10">
          <img src="/icon/mainkronos-logo.png" alt="kronosOS-assistant" className="h-8 w-8" />
        </div>
        <div className="flex-1">
          ...
          <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
            ...
            <Button
              ...
              className="border-[var(--accent-kronos)] bg-[var(--accent-kronos)]/10 text-[var(--accent-kronos)] hover:bg-[var(--accent-kronos)]/20 hover:text-[var(--accent-kronos)]"
            >
