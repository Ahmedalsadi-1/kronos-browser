    ...
    <div className="fade-in slide-in-from-bottom-5 animate-in space-y-6 duration-500">
      ...
      <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--accent-kronos)]/10">
            <Server className="h-6 w-6 text-[var(--accent-kronos)]" />
          </div>
          <div className="flex-1">
            <h2 className="mb-1 font-semibold text-xl">MCP Servers</h2>
            <p className="mb-6 text-muted-foreground text-sm">
              Connect KRONOS assistant to MCP servers to send email, schedule
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                className="border-[var(--accent-kronos)] bg-[var(--accent-kronos)]/10 text-[var(--accent-kronos)] hover:bg-[var(--accent-kronos)]/20"
              >
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
          ...
          <div className="space-y-3">
            {createdServers.map((server) => (
              <div
                key={server.id}
                className="flex items-center gap-4 rounded-lg border border-border bg-background p-4 transition-all hover:border-[var(--accent-kronos)]/50 hover:shadow-sm"
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[var(--accent-kronos)]/10">
                  <Server className="h-5 w-5 text-[var(--accent-kronos)]" />
                </div>
                <div className="flex-1">
                  <div className="mb-1 flex items-center gap-2">
                    ...
                    <span
                      className={`rounded px-2 py-0.5 font-medium text-xs ${
                        server.type === 'managed'
                          ? 'bg-[var(--accent-kronos)]/10 text-[var(--accent-kronos)]'
