 ...
 * Based on: https://github.com/kronos-os-ai/kronosOS-assistant/blob/main/src/options/data/models.ts
 */
export const MODELS_DATA: ModelsData = {
  ...
  browseros: [],
  opencodeai: [
    // API key for opencode.ai needs to be secured via environment variables
    { modelId: 'gpt-5-nano', contextLength: 400000 },
    { modelId: 'grok-code', contextLength: 400000 },
  ],
  z_ai: [
    // API key for z.ai needs to be secured via environment variables
    { modelId: 'glm-4.5-flash', contextLength: 400000 },
  ],
}
