...
function injectStyles(): void {
  ...
  style.textContent = `
    @keyframes browseros-glow-pulse {
      0% {
        box-shadow:
          ...
          inset 0 0 ${50 * t}px ${22 * t}px rgba(147, 51, 234, 0.06),
          inset 0 0 ${42 * t}px ${18 * t}px rgba(147, 51, 234, 0.12),
          inset 0 0 ${34 * t}px ${14 * t}px rgba(147, 51, 234, 0.18);
      }
      50% {
        box-shadow:
          inset 0 0 ${72 * t}px ${35 * t}px transparent,
          inset 0 0 ${64 * t}px ${32 * t}px rgba(147, 51, 234, 0.10),
          inset 0 0 ${54 * t}px ${26 * t}px rgba(147, 51, 234, 0.18),
          inset 0 0 ${46 * t}px ${22 * t}px rgba(147, 51, 234, 0.24);
      }
      100% {
        box-shadow:
          inset 0 0 ${58 * t}px ${26 * t}px transparent,
    ...
    #${GLOW_OVERLAY_ID} {
      ...
      animation:
        browseros-glow-pulse 3s steps(5) infinite,
