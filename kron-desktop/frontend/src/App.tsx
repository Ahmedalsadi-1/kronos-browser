    ...
    <NextUIProvider>
      <AppProvider>
        <ExploreModeProvider>
          ...
          <StorageManager />
          <Router>
            <div className="fixed inset-0 flex flex-col bg-black/60 backdrop-blur-sm overflow-hidden dark">
              {/* Header - fixed height */}
              <div className="h-14 flex-none border-b border-[#2d2d2d]/50 bg-black/40">
                <Header />
              </div>
