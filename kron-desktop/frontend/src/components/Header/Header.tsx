import darkLogo from "../../assets/kronos-logo-dark.png";
import factifaiLogo from "../../assets/kronos-logo-light.png";
        ...
        <div className="flex items-center gap-3">
          <Link to="/">
            <img
              src={factifaiLogo}
              alt="FACTIFAI Logo"
              className="h-8 my-1 w-auto translate-y-[1px] hover:scale-105 transition-transform"
            />
          </Link>
        </div>
